...
public class HashFunction {
    ...
    // Now let's say we have to hold values between 0 & 999 but we never plan to have more than 15 values in all.
    // It wouldn't make sense to make a 1000 item array, so what can we do?

    // One way to fit these numbers into a 30 item array is to use the mod function. All you do is take the modulus
