 ...
 *
 * OPERATIONS
 * - enqueue: add a value onto the rear of the QueueArray (the end of the line)
 * - make sure it is not full first.
 * - dequeue: remove a value from the front of the QueueArray(the front of the line) Next!
 * - make sure it is not empty first.
 * - isFull: true if the QueueArray is currently full.
 ...
 * - For example, imagine the print QueueArray for a computer lab.
 * - Any computer can add a new print job to the QueueArray (enqueue).
 ...
 * -	The previous illustration assumed we were using an array to implement the QueueArray
