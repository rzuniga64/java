...
/**
 *  The LookupCSV class provides a data-driven client for reading in a key-value pairs from a file; then, printing the
 *  values corresponding to the keys found on standard input. Both keys and values are strings.
