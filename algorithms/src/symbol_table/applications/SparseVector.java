 ...
 *  - Euclidean norm.
 *
 *  The implementation is a symbol table of indices and values for which the vector coordinates are nonzero. This makes
 *  it efficient when most of the vector coordinates are zero.
 *
 *  For additional documentation,    
 *  see href="https://algs4.cs.princeton.edu/35applications", Section 3.5 of
