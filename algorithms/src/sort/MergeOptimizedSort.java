...
public class MergeOptimizedSort {
    ...
    public static void sort(Comparable[] a) {
        ...
        Comparable[] aux = a.clone(); // create a auxiliary array used as a placeholder to sort the data
    ...
    public static void main(String[] args) {
        ...
        generateRandomArray(MergeOptimizedSort.theArray, MergeOptimizedSort.theArray.length);
        System.out.println("Before merge sort: ");
        printHorizontalArray(MergeOptimizedSort.theArray, MergeOptimizedSort.theArray.length, -1,-1);
        MergeOptimizedSort.sort(MergeOptimizedSort.theArray);
        System.out.println("\nAfter merge sort: ");
        printHorizontalArray(MergeOptimizedSort.theArray, MergeOptimizedSort.theArray.length, -1,-1);
    }
