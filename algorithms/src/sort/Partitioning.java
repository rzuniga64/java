...
// The value that defines in which group data will go is known as the pivot value
public class Partitioning {
    ...
    public static void main(String[] args) {
        ...
        // Every item smaller than 35 will be on the left and everything bigger will be on the right
    ...
    private void partitionArray(int pivot) {
        ...
        while (true) {
            ...
            // Cycle through array until the end is reached or an item bigger than pivot is found. Then
            ...
            // Cycle through array until the beginning is reached or an item smaller than pivot is found.
