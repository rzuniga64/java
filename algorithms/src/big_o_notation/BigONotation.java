 ...
 * such as asymptotic analysis, which covers comparing algorithms as data approaches infinity.
 *
...
public class BigONotation {
    ...
    /**
     * O(1) An algorithm that executes in the same time regardless of the amount of data.
    ...
    */
    ...
    /** 0(N) An algorithm thats time to complete will grow in direct proportion to the amount of data.
     ...
     *
     * If we just wanted to find one match the Big O is the same because it describes the worst case scenario in which
    ...
    */
     ...
     * The Binary search is a perfect example of this.
     *
     * Pretty fast because the log N increases at a dramatically slower rate as N increases
     *
     * O (log N) algorithms are very efficient because increasing the amount of data has little effect at some point
