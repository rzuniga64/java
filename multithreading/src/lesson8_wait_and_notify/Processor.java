...
public class Processor {
    public void produce() throws InterruptedException {
        ...
        /**
         * need an mutex (object)to synchronize on so we'll use the Processor
        ...
        */
        synchronized (this) {
             ...
             * the Object class.  It waits without using loads of system resources.
             * It can only be called within synchronized code blocks.  It hands
             * over the control of the lock that the synchronized block is
             * locked on. This thread will not resume until two things happen.
             * First, it must be possible for this thread to regain control of
             * this lock in order for it to resume.  Second, I must run another
             * thread that is locked on the same object that calls a method
             * called notify().
             */
    ...
    public void consume() throws InterruptedException {
         ...
         * in the synchronized block.  So if produce is running it wait for it to
