...
public class App2 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // in this example, there are different ways you can interrupt a thread execution.
        //JavaDoc: http://docs.oracle.com/javase/8/docs/api/java/util/concurrent/Future.html#cancel-boolean-fu.cancel(true);
