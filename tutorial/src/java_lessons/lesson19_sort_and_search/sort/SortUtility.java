...
public class SortUtility {
    ...
    public static void generateRandomArray(int[] theArray, int arraySize){
    ...
    public static void printHorizontalArray(int[] theArray, int arraySize, int i, int j){
    ...
    public static void printHorzArray(int[] theArray, int arraySize, int i, int j, int h) {
        if (i == j)
            i = i - h;
