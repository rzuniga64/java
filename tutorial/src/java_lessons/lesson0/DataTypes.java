 ...
 *  Input Format
 *
 *  The first line contains an integer, , denoting the number of OutputFormatting cases.
 *  Each OutputFormatting case, , is comprised of a single line with an integer, , which can
 *  be arbitrarily large or small.
 *
 *  Output Format
 *
 *  For each input variable  and appropriate primitive , you must determine if
