 ...
 *  May contain letters, numbers, and teh underscore character.
...
public class Variables {
    public static void main(String[] args)
    {
        ...
        char letter     = 'a';  // alphabetic characters stored as numeric value (ASCII)

        int value = int1 + (int) long1 + (int) float1 + (int)double1 + byte1 + short1;
