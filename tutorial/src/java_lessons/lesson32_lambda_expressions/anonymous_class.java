...
/**
 *  To use this we need an instance of the Runner1 class.
 *  In previous versions of Java, to actually pass some
 *  block of code we've got to somehow have an object
 *  that implements this interface, and we can do that
 *  using an anonymous class syntax. the point  is
 *  to pass in some code to the run method.  Then the run
 *  method can do what it likes with it, and in this case
 *  it's just executing the code that we passed it in the
 *  execute method.  This is a lot of code just to pass
 *  a code block.  How can we do this with lambda expressions
 *  in Java8?
 */
