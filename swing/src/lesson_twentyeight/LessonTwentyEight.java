...
public class LessonTwentyEight extends JFrame {
    ...
    public LessonTwentyEight() {
		...
		// FlowLayout.RIGHT, FlowLayout.CENTER  		// Define the flow layout alignment
        ...
        // If you put components in the same space the last one in stays and everything else goes. Example:
...
*/
        //  If you want more than one component to show up in the same part of a border layout put them in a panel and
        //  then add the panel to the border layout panel
/*
...
/*
		...
		theBox.add(button4);
*/
        // A rigid area gives you the option to space using horizontal and vertical spacing
        theBox.add(button1);
        theBox.add(button2);
