package lesson_twentyseven;     // Swing allows you to create Graphical User Interfaces
...
import java.util.Enumeration;   // Enumerations are used to store related items together
/*
...
public class LessonTwentySeven extends JFrame{
    ...
    public LessonTwentySeven(){
        ...
        // Makes sure only one item can be selected at a time. By default you can make multiple selections.
        theTree.getSelectionModel().setSelectionMode(TreeSelectionModel.SINGLE_TREE_SELECTION);
        theTree.setVisibleRowCount(8);  // Only show 8 rows of the tree at a time
        // Add the items to the tree documents, work, games. We first add the documents parent node.
    ...
    private class ListenForButton implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e){
            if(e.getSource() == button1){
                ...
                // children() returns an enumeration that contains all the children.  This for loop will continue to
                // run as long as there are more elements nextElement() returns the next element in the list
