...
public class LessonThirty extends JFrame{
    ...
    private JCheckBox morningCheck, afterNCheck, eveningCheck;
    ...
    public LessonThirty(){
        ...
        // Create a date spinner & set default to today, no minimum, or max. Increment the days on button presses
        ...
        // Creates a slider with a min value of 1 thru 100 and an initial value of 1
        ...
        aboutYou = new JTextArea(6, 40);                    // Create a text area that is 6 columns high and 40 long
        aboutYou.setText("Tell us something about you");    // Set the default text for the text area
        aboutYou.setLineWrap(true);                         // If text doesn't fit on a line, jump to the next
        aboutYou.setWrapStyleWord(true);                    // Makes sure that words stay intact if a line wrap occurs
