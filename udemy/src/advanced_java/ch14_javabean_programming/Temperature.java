...
/*
 import need because a javabean because a javabean
 has to be a persistent class. That means we have to
 save the state of an object at any particular time.
 We might write out the fields of a class to disk.
 By that we are saving the state of an object.
*/
...
/*
    ...
    do component bases software design. That means we can write
    ...
    simply plug components in when we need them and simplifiy the sw
    development process.
 */
