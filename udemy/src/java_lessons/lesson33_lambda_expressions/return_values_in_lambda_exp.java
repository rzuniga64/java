...
/**
 *   In this tutorial we're also looking at defining the code that
 *   uses lambda expressions, but most often you just want to create
 *   a button or a thread, and you'll only need to know how to define
 ...
 *  If you’ve just got a single expression, which could even be a
 *  literal value, you don’t even need a return statement.
 */
