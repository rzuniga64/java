...
class UFOEnemyShip extends EnemyShip{
    ...
    // The enemy ship required parts list is sent to this method. They state that the enemy ship must have a weapon and
    // engine assigned. That object also states the specific parts needed to make a regular UFO versus a Boss UFO.
