package creational.abstract_factory.ship.enemyship;
...
public abstract class EnemyShip {
    ...
    // Newly defined objects that represent weapon & engine. These can be changed easily by assigning new parts
    ...
    // Because I defined the toString method in engine when it is printed the String defined in toString goes
    // on the screen
