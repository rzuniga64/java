...
public class WorkWithAnimals{
    ...
    public static void main(String[] args){
        ...
        // Everything is pass by value. The original is not effected by changes in methods
        int randNum = 10;
        fido.changeVar(randNum);

        System.out.println("randNum after method call: " + randNum);

        // Objects are passed by reference to the original object. Changes in methods do effect the object
        ...
        // You can't call a private method even if you define it in the subclass
        // fido.bePrivate();

        // You can execute a private method by using another public method in the class
        fido.accessPrivate();
    ...
    public static void speakAnimal(Animal randAnimal){ System.out.println("Animal says: " + randAnimal.getSound()); }
