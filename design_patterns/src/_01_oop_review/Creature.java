...
abstract public class Creature{
    ...
    // There are no abstract fields in Java, but there are abstract methods.
    // Every method marked abstract must be overridden
    // Not all methods must be abstract and you can also use static methods
