...
public class TestRemote {
    ...
    public static void main(String[] args){
        ...
        // Defining a behavorial.command that we want this device to be performing.  We are going to send a device over and have
        // it execute. TurnTVOn executes a behavorial.command to turn TV on whenever execute is called on this behavorial.command object.
        // It is going to execute the behavorial.command on() inside the Television device
        TurnTVOn onCommand = new TurnTVOn(newDevice);

        // Receiver that performs certain actions whenever it is called.
        DeviceButton onPressed = new DeviceButton(onCommand);

        // Press the button on the remote control. It is going to send a generic behavorial.command over that is going to be
        ...
        //----------------------------------------------------------
		 ...
		 // It is common to be able to undo a behavorial.command in a behavorial.command pattern. To do so, DeviceButton will have a method
        ...
        // To undo more than one behavorial.command add them to a LinkedList using addFirst(). Then execute undo on each item until
