...
public class CredentialUniDirectionalOneToOne {
	...
	public UserUnidirectionalOneToOne getUser() { return user; }

	public void setUser(UserUnidirectionalOneToOne user) { this.user = user; }
