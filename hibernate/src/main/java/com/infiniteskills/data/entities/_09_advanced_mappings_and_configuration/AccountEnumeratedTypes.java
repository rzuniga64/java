...
@Entity
@Table(name = "ACCOUNT")
// @NamedQueries is a JPA annotation and it accepts an array of named queries.  The name must be unique for the
// persistence context.
@NamedQueries({
        @NamedQuery(name="Account.largeDeposits", query= "select distinct t.account from TransactionEnumeratedTypes t"
...
public class AccountEnumeratedTypes {
	...
	public List<TransactionHibernateAPI> getTransactions() {
		return transactions;
	}

	public void setTransactions(List<TransactionHibernateAPI> transactions) {
	...
	public void setUsers(Set<UserHibernateAPI> users) {
		this.users = users;
	}
