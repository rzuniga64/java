...
@Entity
@Table(name = "ACCOUNT")
public class AccountBiDirectionalManyToMany {
	...
	private Set<UserBiDirectionalManyToMany> users = new HashSet<UserBiDirectionalManyToMany>();
	...
	public Set<UserBiDirectionalManyToMany> getUsers() {
		return users;
	}

	public void setUsers(Set<UserBiDirectionalManyToMany> users) { this.users = users; }
}
