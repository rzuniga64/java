...
public class CredentialBiDirectionalManyToMany {
	...
	public UserBiDirectionalManyToMany user;
	...
	public UserBiDirectionalManyToMany getUser() { return user; }

	public void setUser(UserBiDirectionalManyToMany user) { this.user = user; }
