...
public class TransactionBiDirectionalOneToMany {
    ...
    public AccountBiDirectionalOneToMany getAccount() { return account; }

    public void setAccount(AccountBiDirectionalOneToMany account) {
