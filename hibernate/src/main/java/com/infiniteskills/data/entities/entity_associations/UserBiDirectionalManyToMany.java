...
public class UserBiDirectionalManyToMany {
	...
	private CredentialBiDirectionalManyToMany credential;
	...
	public CredentialBiDirectionalManyToMany getCredential() {
		return credential;
	}

	public void setCredential(CredentialBiDirectionalManyToMany credential) {
		this.credential = credential;
	}

	public Set<AccountBiDirectionalManyToMany> getAccounts() {
		return accounts;
	}

	public void setAccounts(Set<AccountBiDirectionalManyToMany> accounts) {
