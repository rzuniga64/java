...
public class AccountModel extends AbstractModel implements Serializable {
    private static final String accountsSer = "C:\\User\\Owner\\git\\java\\simple_account\\src\\model\\accounts.ser";
    private static final String accountsFile = "C:\\User\\Owner\\git\\java\\simple_account\\src\\model\\accounts.txt";
...
/*
    ...
    public static void readAccountInputFile() {
        ...
        try {
            Scanner inFile = new Scanner(new FileReader(accountsFile));
